 ...
 */
final class Version20241210230834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD followers LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', ADD following LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
